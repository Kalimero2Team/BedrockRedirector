...
public class PaletteManager {
    ...
    static {
        InputStream stream = Server.class.getClassLoader().getResourceAsStream("tables/biome_definitions.dat");
    ...
    static {
        InputStream stream = Server.class.getClassLoader().getResourceAsStream("tables/entity_identifiers.dat");
    ...
    static {
        /* Load creative items */
        InputStream stream = Server.class.getClassLoader().getResourceAsStream("tables/creative_items.json");
    ...
    public PaletteManager() {
        InputStream stream = Server.class.getClassLoader().getResourceAsStream("tables/runtime_block_states.dat");
        if (stream == null) {
